...
public:
    ...
    ofxFloatSlider guiDepth;
    ofxFloatSlider guiCurveY;
    ofxFloatSlider guiCurveYMin;
    ofxFloatSlider guiCurveYMax;
    ofxFloatSlider guiCurveNoise;
    ofxFloatSlider guiCurveSpeedTime;
    
    bool hide;
    vector<ofParticle> myParticles;
};
